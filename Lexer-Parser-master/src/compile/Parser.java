...
public class Parser extends MainComplier{
    ...
    public ArrayList<String> readFile(File file) {
        ...
        try {
            if (choice == 1) {
                br = new BufferedReader(new FileReader("./grammer//a1.txt"));
            } else if (choice == 2){
                br = new BufferedReader(new FileReader("./grammer//a2.txt"));
            } else if (choice == 3){
                br = new BufferedReader(new FileReader("./grammer//a3.txt"));
            } else if (choice == 4){
                br = new BufferedReader(new FileReader("./grammer//a4.txt"));
            }
            String s = null;
